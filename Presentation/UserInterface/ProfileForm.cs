...
namespace Task_Management_System.Presentation.UserInterface
{
    public partial class ProfileForm : Form
    {
        ...
        private async void UpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            await _userServices.UpdateAccountUserWithPasswordAsync(updatedUser);
        ...
        {
            PasswordVisibilityHelper.ShowPassword(NewPasswordTxt, HidePasswordBtn, ShowPasswordBtn);
        }
        ...
        {
            PasswordVisibilityHelper.ShowPassword(CurrentPasswordTxt, HidePasswordBtn, ShowPasswordBtn);
        }

        private void HideCurrentPasswordBtn_Click(object sender, EventArgs e)
        {
            PasswordVisibilityHelper.HidePassword(CurrentPasswordTxt, ShowPasswordBtn, HidePasswordBtn);
