...
namespace Task_Management_System.Presentation
{
    public partial class LoginForm : Form
    {
        ...
        {
            var registerForm = Program.ServiceProvider.GetRequiredService<RegisterAdminForm>();
            registerForm.Show();
            this.Hide();
        }
        ...
        private async void LoginBtn_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                if (PasswordHashAndSalt.VerifyPasswordHash(password, user.PasswordHash, user.PasswordSalt))
                {
                    ...
                    this.Hide();
                    var mainForm = Program.ServiceProvider.GetRequiredService<NavigationBarForm>();
                    mainForm.Show();
                    ClearFields();
                    return;
                }
