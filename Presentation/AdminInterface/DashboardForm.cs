...
namespace Task_Management_System.Presentation.AdminInterface
{
    public partial class DashboardForm : Form
    {
        ...
        private async Task InitializeChart()
        {
            ...
            int notStartedCount = await _taskServices.GetNotStartedTasksCountAsync();
            int incompleteTasksCount = await _taskServices.GetIncompleteTaskCountAsync();
            ...
            var categoryAxis = new CategoryAxis
            {
                ...
                Title = "Task Status",
                Labels = { "Not Started", "Incomplete", "In Progress", "Completed" } 
            };
            ...
            taskSeries.Points.Add(new DataPoint(0, notStartedCount));  
        ...
        {
            int incompleteCount = await _taskServices.GetIncompleteTaskCountAsync();
