namespace Task_Management_System.Presentation.AdminInterface
{
    partial class ForgotPasswordForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            LoginwithPasswordBtn = new Label();
            EmailLbl = new Label();
            LoginBtn = new Label();
            label5 = new Label();
            ...
            SecurityQuestionPanel.Controls.Add(LoginwithPasswordBtn);
            ...
            PasswordPanel.Controls.Add(BackToLoginBtn);
            ...
            PasswordPanel.Location = new Point(-1, -2);
            ...
            // BackToLoginBtn
            // 
            BackToLoginBtn.BackColor = Color.Transparent;
            BackToLoginBtn.Font = new Font("Segoe UI", 10.2F, FontStyle.Bold, GraphicsUnit.Point);
            BackToLoginBtn.ForeColor = Color.DarkRed;
            BackToLoginBtn.Location = new Point(13, 329);
            BackToLoginBtn.Name = "BackToLoginBtn";
            BackToLoginBtn.Size = new Size(94, 29);
            BackToLoginBtn.TabIndex = 25;
            ...
            // 
            LoginwithPasswordBtn.AutoSize = true;
            LoginwithPasswordBtn.Font = new Font("Segoe UI Semibold", 10.8F, FontStyle.Bold, GraphicsUnit.Point);
            LoginwithPasswordBtn.ForeColor = Color.FromArgb(32, 49, 189);
            LoginwithPasswordBtn.Location = new Point(4, 321);
            LoginwithPasswordBtn.Name = "LoginwithPasswordBtn";
            LoginwithPasswordBtn.Size = new Size(189, 25);
            LoginwithPasswordBtn.TabIndex = 26;
            LoginwithPasswordBtn.Text = "Log in with password";
            LoginwithPasswordBtn.Click += LoginwithPasswordBtn_Click;
            // 
            // EmailLbl
            // 
        ...
        private Label LoginwithPasswordBtn;
    }
}